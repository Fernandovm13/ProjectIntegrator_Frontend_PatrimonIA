...
class MemoryLocalDataSourceImpl implements MemoryLocalDataSource {
  const MemoryLocalDataSourceImpl();

  @override
  Future<List<Memory>> getMemories() async => _seedMemories();
  ...
  List<Memory> _seedMemories() {
    return [
      ...
      Memory(
        ...
        community: 'San Cristóbal de las Casas',
        content:
            'Las noches de luna llena, dicen los ancianos, se escucha el llanto de una mujer que busca a sus hijos junto al río...',
        author: 'Doña Caterina Gómez',
        duration: '3 min',
        icon: Icons.eco,
        color: AppColors.categoryLeyenda,
      ...
      Memory(
        ...
        community: 'Chamula',
        content:
            'Cuando la milpa da sus primeros elotes, la comunidad entera se reúne para agradecer...',
      ...
      Memory(
        ...
        community: 'Tenejapa',
        content:
            'Un registro oral sobre crónicas comunitarias que detallan encuentros con un supuesto nagual felino...',
      ...
      Memory(
        ...
        community: 'Zinacantán',
        content:
            'Los caracoles marinos son utilizados como instrumento ceremonial en las festividades...',
        author: 'Ana López',
        duration: '2 min',
