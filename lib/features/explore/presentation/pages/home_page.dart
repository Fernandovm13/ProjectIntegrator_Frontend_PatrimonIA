...
import '../riverpod/community_riverpod.dart';
    ...
    return Scaffold(
      ...
      body: memoriesAsync.when(
        ...
        data: (memoryState) {
          ...
          final selectedCommunity = community?.selected;

          final featuredMemories = memories
                        ...
                        for (final entry in _categoryMap.entries)
                          Padding(
                            padding: EdgeInsets.only(
                              right: entry.key != _categoryMap.entries.last.key
                                  ? 8
                                  : 0,
                            ),
                            child: CategoryChip(
